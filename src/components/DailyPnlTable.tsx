...
type SortField = 'date' | 'pnl' | 'trades' | 'winRate' | 'avgReturn' | 'fees';
type SortDirection = 'asc' | 'desc';

export default function DailyPnlTable({ matchedTrades }: DailyPnlTableProps) {
  ...
  const totals = useMemo(() => {
    return dailyData.reduce(
      ...
      { pnl: 0, trades: 0, wins: 0, totalCost: 0, fees: 0 },
    );
  }, [dailyData]);
